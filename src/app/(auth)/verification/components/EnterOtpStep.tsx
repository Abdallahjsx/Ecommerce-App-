    ...
    >
      ...
      <Typography
        sx={{
          ...
          marginTop: "5px",
          [t.breakpoints.down("md")]: { fontSize: "11px", lineHeight: "20px" },
          [t.breakpoints.down("sm")]: { fontSize: "10px", lineHeight: "18px" },
        }}
      >
      ...
      >
        ...
        <Box
          sx={{
            ...
            [t.breakpoints.down("sm")]: { bottom: "-28px", fontSize: "12px" },
          }}
        >
          <Image
      ...
      >
        <Gradient_Button size="large" onClick={setStep}>
          Verify Code
        </Gradient_Button>
      </Box>
      ...
      <Box
        sx={{
          ...
          height: "80px",
          borderRadius: "12px",
          background: "var(--Colors-Background-Info, #DDEEFD)",
          margin: "32px auto 0",
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <Typography
          sx={{
            ...
            fontSize: "10px",
            lineHeight: "15px",
            color: "var(--Colors-Text-Info, #136EBF)",
            textAlign: "left",
            [t.breakpoints.down("sm")]: { fontSize: "9px", lineHeight: "13px" },
          }}
        >
          If you’re experiencing issues with verification, please check your spam
          folder or reach out to our support team for help.
        </Typography>
      </Box>
      ...
      >
        <Image
          src="/assets/icons/connect-icon.svg"
